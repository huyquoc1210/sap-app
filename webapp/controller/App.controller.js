sap.ui.define(["sap/ui/Device", "sap/ui/model/Filter", "sap/ui/model/FilterOperator", "sap/ui/model/json/JSONModel", "./BaseController"], function (browser, Filter, FilterOperator, JSONModel, __BaseController) {
  "use strict";
  ...
  var App = BaseController.extend("sap.m.sample.TsTodos.webapp.controller.App", {
    ...
    _applyListFilters: function _applyListFilters() {
      ...
      if (i18nKey) {
        var _this$getView;
        var resourceModel = (_this$getView = this.getView()) === null || _this$getView === void 0 ? void 0 : _this$getView.getModel("i18n");
